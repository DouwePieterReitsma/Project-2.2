...
class MTServer {
    ...
    private static ArrayList<String> stationsIranRadius = new ArrayList<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            Thread worker = new Thread(new ServerThread(connection, countryArray()));
            worker.start();
        }
    }

    private static ArrayList<String> countryArray() {
